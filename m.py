...
TOKEN = '7237938018:AAH28PSuL0yg3a13iMtqXrYWOECFOAU0WAE'
...
FORWARD_CHANNEL_ID = -1123761096
CHANNEL_ID = -1123761096
error_channel_id = -1123761096
...
def attack_command(message):
    ...
    try:
        ...
        if user_data['plan'] == 1 and users_collection.count_documents({"plan": 1}) > 99:
            bot.send_message(chat_id, "Your Instant Attack 1 is currently not available due to limit reached.")
            return

        if user_data['plan'] == 2 and users_collection.count_documents({"plan": 2}) > 499:
            bot.send_message(chat_id, "Your Attack 2 is currently not available due to limit reached.")
            return
